...
class HamburgesaIngredientesBloc {

  final StreamController<List> _tomateController          = StreamController<List>.broadcast();
  ...
  final StreamController<List> _tocinetaController        = StreamController<List>.broadcast();
  ...
  Stream<List> get tomateStream          => _tomateController.stream; 
  Stream<List> get ensaladaStream        => _ensaladaController.stream; 
  Stream<List> get ripioStream           => _ripioController.stream; 
  Stream<List> get tocinetaStream        => _tocinetaController.stream; 
  ...
  Function(List) get  tomateControllerCantidad         => _tomateController.sink.add;
  ...
  Function(List) get  tocinetaControllerCantidad       => _tocinetaController.sink.add;
  ...
  dispouse(){
    ...
    _tomateController.close();
    _ensaladaController.close();
    _ripioController.close();
    _tocinetaController.close();
